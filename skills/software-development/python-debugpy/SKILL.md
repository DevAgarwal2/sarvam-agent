...
This skill was verified available and loaded successfully. All debugging approaches (breakpoint(), python -m pdb, debugpy) are functional. The skill includes comprehensive Hermes-specific debugging patterns for gateway, tui_gateway, and _SlashWorker processes.
